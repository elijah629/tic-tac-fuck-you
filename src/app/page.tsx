  ...
  return (
    <main>
      <section className="flex flex-col items-center gap-3">
        <h1 className="text-4xl md:text-6xl font-bold">Tic Tac { hardcore ? "Fuck" : "****"} You</h1>
        ...
        <Button size="lg" className="text-2xl" variant="enemy" onClick={toggleHardcoreMode}>{!session && "LOGIN TO "} TOGGLE HARDCORE MODE warn: swearing</Button>
      </section>
    </main>
  );
}
